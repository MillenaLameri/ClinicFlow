    ...
    : ControllerBase
{
    ...
    [ProducesResponseType(
        typeof(PagedResponse<DoctorResponse>),
    ...
    )
    {
        ...
        // Evita que o e-mail cadastrado
        // no médico fique diferente
        // do e-mail utilizado no login.
        if (
        ...
        )
        {
            return Problem(
                ...
                detail:
                    "O e-mail deste médico está vinculado a uma conta de acesso e não pode ser alterado por este endpoint."
            );
        }
    ...
    private ObjectResult SpecialtyNotFound(
        Guid id
    )
    {
        return Problem(
    ...
    private ObjectResult DoctorEmailConflict(
        string email
    )
    {
        return Problem(
    ...
    private ObjectResult InvalidDoctorData(
        string detail
    )
    {
        return Problem(
